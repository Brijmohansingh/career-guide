      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/blog" className="text-gray-300 hover:text-white transition-colors">Career Blog</Link></li>
              <li><Link href="/tools" className="text-gray-300 hover:text-white transition-colors">Career Tools</Link></li>
